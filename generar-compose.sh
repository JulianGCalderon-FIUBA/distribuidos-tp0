...
append "    entrypoint: python3 /main.py"
append "    environment:"
append "      - PYTHONUNBUFFERED=1"
append "      - LOGGING_LEVEL=DEBUG"
append "    volumes:"
append "      - \${PWD}/server/config.ini:/config.ini"
append "    networks:"
append "      - testing_net"
append ""
...
append "    environment:"
append "      - CLI_ID=$i"
append "      - CLI_LOG_LEVEL=DEBUG"
append "    volumes:"
append "      - \${PWD}/client/config.yaml:/config.yaml"
append "    networks:"
append "      - testing_net"
append "    depends_on:"
append "      - server"
